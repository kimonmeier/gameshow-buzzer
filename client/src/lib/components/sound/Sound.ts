...
export class Sound {
    ...
    private howl!: Howl;
    private volumeStoreUnsubscriber?: Unsubscriber | undefined;
	...
	constructor(
		...
		this.create().then(() => {
			this.volumeStoreUnsubscriber = volumeStore?.subscribe((value) => {
	...
	private unload() {
        this.howl.unload();
        if (this.volumeStoreUnsubscriber) {
            this.volumeStoreUnsubscriber();
        }
	}
}
